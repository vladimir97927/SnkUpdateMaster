...
## 📚 Модули проекта
- [Core - основные компоненты работы приложения.](SnkUpdateMaster/docs/ru/Core.md)
- [SqlServer - реализация работы с обновлениями через реляционную базу данных.](SnkUpdateMaster/docs/ru/SqlServer.md)
- [SnkUpdateMasterDb - проект базы данных.](SnkUpdateMaster/docs/ru/SnkUpdateMasterDb.md)
- [Ftp - реализация работы с обновлениями через FTP-сервер](SnkUpdateMaster/docs/ru/Ftp.md)
