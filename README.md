...
Пример использования с хранением метаданных обновлений в БД и файлов обновлений на FTP-сервере. Текущая версия приложения хранится в файле `[app directory]\version` в виде строки формата `major.minor.build.
Целостность файлов обновлений проверяется хэш функцией алгоритмом `sha256`. Файлы обновления содержатся в ZIP архиве.
...
- [Ftp - реализация работы с обновлениями через FTP-сервер](docs/Ftp.md)
